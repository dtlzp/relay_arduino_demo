...
#define HC595165_PL(x)     gpio_set_level((gpio_num_t)g_dt.gpio_595165_pl, (x))
#define HC595165_EN(x)     gpio_set_level((gpio_num_t)g_dt.gpio_595165_pl, (x))
#define HC595165_RCK(x)    gpio_set_level((gpio_num_t)g_dt.gpio_595165_rck, (x))
#define HC595165_CLK(x)    gpio_set_level((gpio_num_t)g_dt.gpio_595165_clk, (x))
#define HC595165_SDI(x)    gpio_set_level((gpio_num_t)g_dt.gpio_595165_sdi, (x))
#define HC595165_Q7()      gpio_get_level((gpio_num_t)g_dt.gpio_595165_q7)
