...
void factory_led_init(void)
{
    ...
    gpio_set_level((gpio_num_t)g_dt.gpio_factory_run_led, !g_dt.factory_run_led_level);
}
...
void factory_led_action(b8_t on)
{
    ...
    gpio_set_level((gpio_num_t)g_dt.gpio_factory_run_led, (0 == g_dt.factory_run_led_level) ? (!on):(on));
}
