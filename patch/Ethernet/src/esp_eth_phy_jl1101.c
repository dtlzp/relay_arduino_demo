...
static esp_err_t jl1101_negotiate(esp_eth_phy_t *phy)
{
    ...
    bmsr_reg_t bmsr;
    uint32_t to = 0;
    bmcr.speed_select = 1;     /* 100Mbps */
    bmcr.duplex_mode = 1;      /* Full Duplex */
    bmcr.en_auto_nego = 1;     /* Auto Negotiation */
...
esp_eth_phy_t *esp_eth_phy_new_jl1101(const eth_phy_config_t *config)
{
    ...
    phy_jl1101_t *jl1101 = (phy_jl1101_t*)calloc(1, sizeof(phy_jl1101_t));
    PHY_CHECK(config, "can't set phy config to null", err);
